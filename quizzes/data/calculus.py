...
def get_calculus_quizzes():
    ...
    quizzes.extend([
        {
            ...
            'topic': 'Limits',
            'description': "Write your answer in your own words, then compare it to the model answer. Remember, this exercise is built on trust and personal responsibility. Marking incorrect answers as right mimics progress but hinders true understanding. Embrace the learning process—honesty here is the foundation of your growth.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_1,
            'topic': 'Limits',
            'description': "Type in the answer directly. These questions are automatically graded to test your precision and recall.",
            'questions': [
    ...
    quizzes.extend([
        {
            ...
            'description': "Solve the problems below. For each question, type your final answer. After submitting, you will see the detailed step-by-step solution. Compare your work honestly and mark yourself correct only if your process and answer align.",
            'questions': [
                (1, 'Evaluate the limit: $\lim_{x \\to -2} (3x^3 - 5x + 1)$', '-13', 'Since this is a polynomial, use Direct Substitution.\n\nCalculation:\n1. $3(-2)^3 - 5(-2) + 1$\n2. $3(-8) + 10 + 1$\n3. $-24 + 11 = -13$.'),
                (2, 'Evaluate the limit: $\lim_{x \\to 5} \\frac{x^2 - 25}{x - 5}$', '10', 'Plugging in 5 gives $0/0$. We must factor.\n\nSteps:\n1. Factor numerator (Difference of Squares): $(x-5)(x+5)$.\n2. Cancel $(x-5)$ from top and bottom.\n3. Limit becomes $\lim_{x \\to 5} (x+5)$.\n4. Substitute 5: $5 + 5 = 10$.'),
                (3, 'Evaluate the limit: $\lim_{x \\to 9} \\frac{\\sqrt{x} - 3}{x - 9}$', '1/6', 'Plugging in 9 gives $0/0$. Use the conjugate.\n\nSteps:\n1. Multiply by $\\frac{\\sqrt{x} + 3}{\\sqrt{x} + 3}$.\n2. Numerator becomes $x - 9$.\n3. Denominator becomes $(x-9)(\\sqrt{x}+3)$.\n4. Cancel $(x-9)$: Limit is $\\frac{1}{\\sqrt{x}+3}$.\n5. Plug in 9: $\\frac{1}{\\sqrt{9}+3} = \\frac{1}{3+3} = 1/6$.'),
                (4, 'Evaluate the limit at infinity: $\lim_{x \\to \\infty} \\frac{10x^3 - 2}{5x^3 + x^2 + 100}$', '2', 'Degrees are equal (both are $x^3$).\n\nMethod:\n1. Identify leading coefficients: 10 for numerator, 5 for denominator.\n2. Divide: $10 / 5 = 2$.\n3. (Alternatively divide every term by $x^3$ and observe smaller terms go to 0).'),
                (5, 'Evaluate the trig limit: $\lim_{x \\to 0} \\frac{\\sin(2x)}{\\sin(3x)}$', '2/3', 'Use the identity $\lim \\frac{\\sin(kx)}{kx} = 1$.\n\nSteps:\n1. Rewrite as $\\frac{\\sin(2x)}{2x} \\cdot 2x \\cdot \\frac{3x}{\\sin(3x)} \\cdot \\frac{1}{3x}$.\n2. The trig parts go to 1.\n3. The $x$s cancel, leaving $2/3$.'),
                (6, 'Find the Right-Hand Limit: $\lim_{x \\to 0^+} \\frac{1}{x}$', 'Positive Infinity', 'As $x$ approaches 0 from the positive side (e.g., $x=0.1, x=0.01$), the fraction $1/x$ becomes very large (10, 100). The values grow without bound towards positive infinity.'),
                (7, 'Evaluate the limit: $\lim_{x \\to 1} \\frac{\\frac{1}{x+1} - \\frac{1}{2}}{x - 1}$', '-1/4', 'Common denominator strategy.\n\nSteps:\n1. Combine top fractions: $\\frac{2 - (x+1)}{2(x+1)} = \\frac{1-x}{2(x+1)}$.\n2. Note that $1-x = -(x-1)$.\n3. Cancel $(x-1)$ with denominator.\n4. Result is $\\frac{-1}{2(x+1)}$.\n5. Plug in $x=1$: $\\frac{-1}{2(2)} = -1/4$.'),
                (8, 'Evaluate the limit at infinity: $\lim_{x \\to \\infty} \\frac{\\sin(x)}{x}$', '0', 'Squeeze Theorem application.\n\nReasoning:\n1. We know $-1 \\le \\sin(x) \\le 1$.\n2. Divide by $x$: $-\\frac{1}{x} \\le \\frac{\\sin(x)}{x} \\le \\frac{1}{x}$.\n3. As $x \\to \\infty$, both $-\\frac{1}{x}$ and $\\frac{1}{x}$ go to 0.\n4. Therefore, the middle term must go to 0.'),
                (9, 'Evaluate the limit: $\lim_{x \\to 0} \\frac{1 - \\cos(x)}{x}$', '0', 'This is a standard trigonometric limit, often proven using conjugates.\n\nSteps:\n1. Multiply by $(1+\\cos x)$.\n2. Numerator becomes $1-\\cos^2 x = \\sin^2 x$.\n3. Rewrite as $(\\frac{\\sin x}{x}) \\cdot \\sin x \\cdot \\frac{1}{1+\\cos x}$.\n4. Limit is $1 \\cdot 0 \\cdot (1/2) = 0$.'),
                (10, 'Given $f(x) = x^2$ for $x \\neq 2$ and $f(2) = 10$. What is $\lim_{x \\to 2} f(x)$?', '4', 'The limit depends on the values approaching 2, not the value AT 2.\n\nReasoning:\n1. As $x$ gets close to 2 (but is not 2), $f(x) = x^2$.\n2. $2^2 = 4$.\n3. The fact that $f(2)=10$ is a discontinuity, but it does not change the limit.')
            ]
        },
        {
        ...
        },
        {
            ...
            'description': "Solve the problems below. For each question, type your final answer. After submitting, you will see the detailed step-by-step solution. Compare your work honestly and mark yourself correct only if your process and answer align.",
            'questions': [
                (1, 'Evaluate the limit: $\\lim_{x \\to 3} \\frac{x^2 - 9}{x - 3}$', '6', 'Direct substitution gives 0/0. Factor the numerator: $(x-3)(x+3)$. Cancel the $(x-3)$ terms. Evaluate $x+3$ at $x=3$, which gives $3+3=6$.'),
                (2, 'Find the derivative $f\'(x)$ for the function $f(x) = 5x^3 - 2x + 10$.', '15x^2 - 2', 'Use the Power Rule $\\frac{d}{dx}(ax^n) = anx^{n-1}$.\n1. For $5x^3$: $3 \\cdot 5x^{2} = 15x^2$.\n2. For $-2x$: The derivative is $-2$.\n3. For $10$: The derivative of a constant is 0.'),
                (3, 'Evaluate this limit by recognizing it as the definition of a derivative: $\\lim_{h \\to 0} \\frac{(x+h)^2 - x^2}{h}$', '2x', 'Do not expand the algebra. Recognize that this structure is the Limit Definition of the Derivative for the function $f(x) = x^2$. The derivative of $x^2$ is simply $2x$.'),
                (4, 'Find the derivative of $y = x^2 \\sin(x)$.', '2x sin(x) + x^2 cos(x)', 'Use the Product Rule: $(uv)\' = u\'v + uv\'$.\nHere $u=x^2$ (so $u\'=2x$) and $v=\\sin(x)$ (so $v\'=\\cos(x)$).\nCombine: $(2x)(\\sin x) + (x^2)(\\cos x)$.'),
                (5, 'What is the slope of the tangent line to the curve $y = \\sqrt{x}$ at the point where $x = 4$?', '1/4', '1. Find the derivative: $y = x^{1/2}$, so $y\' = \\frac{1}{2}x^{-1/2} = \\frac{1}{2\\sqrt{x}}$.\n2. Plug in $x=4$: $\\frac{1}{2\\sqrt{4}} = \\frac{1}{2(2)} = 1/4$.'),
                (6, 'Differentiate using the Chain Rule: $y = (3x^2 + 1)^5$.', '30x(3x^2 + 1)^4', 'Identify Outer function $(\\dots)^5$ and Inner function $(3x^2+1)$.\n1. Deriv of Outer: $5(3x^2+1)^4$.\n2. Deriv of Inner: $6x$.\n3. Multiply: $5(3x^2+1)^4 \\cdot 6x = 30x(3x^2+1)^4$.'),
                (7, 'Evaluate $\\lim_{x \\to \\infty} \\frac{4x^2 - x}{2x^2 + 5}$.', '2', 'Compare degrees. Both are $x^2$. Therefore, the limit is the ratio of the leading coefficients: $4/2 = 2$.'),
                (8, 'Find the derivative of the quotient: $y = \\frac{x}{x+1}$.', '1 / (x+1)^2', 'Use Quotient Rule: $\\frac{u\'v - uv\'}{v^2}$.\n$u=x, u\'=1$. $v=x+1, v\'=1$.\nNumerator: $1(x+1) - x(1) = x + 1 - x = 1$.\nDenominator: $(x+1)^2$.'),
                (9, 'A particle\'s position is given by $s(t) = t^2 - 4t + 3$. What is its velocity at $t = 5$?', '6', 'Velocity is the derivative of position.\n1. $v(t) = s\'(t) = 2t - 4$.\n2. Evaluate at $t=5$: $2(5) - 4 = 10 - 4 = 6$.'),
                (10, 'Find the derivative of $y = \sin^3(2x)$.', '6sin^2(2x)cos(2x)', 'Use Chain Rule twice.\nOuter: $u^3 \\to 3u^2$.\nInner 1: $\\sin(v) \\to \\cos(v)$.\nInner 2: $2x \\to 2$.\n\nMultiply: $3(\\sin(2x))^2 \\cdot \\cos(2x) \\cdot 2 = 6\\sin^2(2x)\\cos(2x)$.'),
                (11, 'At which x-value is the function $f(x) = |x - 2|$ NOT differentiable? Why?', '2', 'The graph of $|x-2|$ is a V-shape shifted to $x=2$. At the tip of the V ($x=2$), there is a sharp corner (cusp). Derivatives are undefined at sharp corners.'),
                (12, 'If $f(x) = e^x$, what is the value of $\\lim_{h \\to 0} \\frac{e^{(0+h)} - e^0}{h}$?', '1', 'This limit represents the derivative of $e^x$ at $x=0$.\n1. We know $f\'(x) = e^x$.\n2. Evaluate at $0$: $e^0 = 1$.')
            ]
        },
        {
            ...
            'description': "Write your answer in your own words, then compare it to the model answer. Remember, this exercise is built on trust and personal responsibility. Marking incorrect answers as right mimics progress but hinders true understanding. Embrace the learning process—honesty here is the foundation of your growth.",
            'questions': [
                (1, 'Explain the intuitive logic behind the Chain Rule using a "rates of change" analogy (e.g., gears or conversion rates).', 'If y changes 3 times as fast as u, and u changes 2 times as fast as x, then y changes 3 * 2 = 6 times as fast as x. We multiply the rates because the effects compound.', ''),
                (2, 'In the Chain Rule formula $\\frac{dy}{dx} = \\frac{dy}{du} \\cdot \\frac{du}{dx}$, what does the variable $u$ represent?', 'The variable $u$ represents the "inner" function. It acts as the output of the first function and the input for the second function.', ''),
                (3, 'Why is $\\sin(x^2)$ structurally different from $\\sin^2(x)$? How does this change the differentiation process?', 'In $\\sin(x^2)$, the squaring happens *inside* to the angle (Outer: sin, Inner: x^2). In $\\sin^2(x)$, the squaring happens *outside* to the whole result (Outer: x^2, Inner: sin). You must peel the layers in the correct order.', ''),
                (4, 'When applying the Chain Rule to $f(g(h(x)))$, how many derivatives will you end up multiplying together?', 'Three. You differentiate the outer layer f, multiply by the derivative of the middle layer g, and multiply by the derivative of the inner layer h.', ''),
                (5, 'What is the difference between "Implicit Differentiation" and the "Chain Rule"?', 'They are actually the same thing. Implicit differentiation is just applying the Chain Rule to the variable y (treating y as an unknown function y(x)) whenever we differentiate a term containing y.', ''),
                (6, 'If $f(x)$ is continuous at $x=c$, does that guarantee that $\\lim_{x \\to c} f(x)$ exists? Why?', 'Yes. By definition of continuity, the limit must exist and it must equal the function value f(c).', ''),
                (7, 'If you know the derivative of $f(x)$ is $f\'(x)$, how do you find the derivative of the inverse function $f^{-1}(x)$ using the Chain Rule?', 'You differentiate the identity $f(f^{-1}(x)) = x$. Applying the Chain Rule gives $f\'(f^{-1}(x)) \\cdot (f^{-1})\'(x) = 1$. Then solve for the inverse derivative.', ''),
                (8, 'In Machine Learning, gradients are calculated "backwards". How does this relate to the Chain Rule?', 'The Chain Rule calculates the total rate of change by multiplying local derivatives. Backpropagation computes these products from the last layer (output) back to the first layer (input) to update weights.', ''),
                (9, 'Why does the derivative of $e^{kx}$ equal $k \\cdot e^{kx}$ instead of just $e^{kx}$?', 'Because of the Chain Rule. The outer function is $e^u$ (deriv is $e^u$) and the inner function is $u=kx$ (deriv is k). Multiplying them gives $k e^{kx}$.', ''),
                (10, 'Describe a "cusp" on a graph. Why does the derivative fail to exist there?', 'A cusp is a sharp point where the tangent line becomes vertical or the left-hand slope and right-hand slope are not equal. The limit of the difference quotient does not exist.', ''),
                (11, 'What is the "Linear Approximation" of a function $f(x)$ at a point $a$?', 'It is the equation of the tangent line: $L(x) = f(a) + f\'(a)(x-a)$. It estimates the function values near $x=a$ using the derivative.', ''),
                (12, 'Evaluate the limit of a composite function $\\lim_{x \\to c} f(g(x))$ if both are continuous.', 'You can move the limit inside. The result is simply $f(\\lim_{x \\to c} g(x))$, which equals $f(g(c))$.', '')
            ]
        },
        {
        ...
        },
        {
            ...
            'description': "Write your answer in your own words, then compare it to the model answer. Remember, this exercise is built on trust and personal responsibility. Marking incorrect answers as right mimics progress but hinders true understanding. Embrace the learning process—honesty here is the foundation of your growth.",
            'questions': [
                (1, 'Explain why a Critical Point (where f\'(c)=0) is a *candidate* for a local maximum or minimum, but not a guarantee. Give a counter-example.', 'A derivative of zero means the tangent is horizontal, but the function could flatten out and then continue going up (like y = x^3 at x=0). This is called a "saddle point" or inflection point, not a max/min.', ''),
                (2, 'State Rolle\'s Theorem. How is it a special case of the Mean Value Theorem?', 'Rolle\'s Theorem states that if f(a) = f(b), there must be a point between them where f\'(c) = 0. This is just the MVT where the average rate of change is zero (the secant line is horizontal).', ''),
                (3, 'Explain why the derivative of ln(x) cannot exist for x < 0.', 'Because the natural logarithm ln(x) is not defined for negative numbers (domain restriction). You cannot have a slope where the graph does not exist.', ''),
                (4, 'Explain the First Derivative Test. How do you use the *signs* of f\'(x) to classify a critical point?', 'You check the sign of f\'(x) on both sides of the critical point. If f\' changes from Positive to Negative, it\'s a Peak (Max). If it changes from Negative to Positive, it\'s a Valley (Min).', ''),
                (5, 'Geometrically, what does it mean for a function to be Concave Up? Relate this to the tangent lines.', 'Concave Up means the graph opens upward (like a cup). Geometrically, the graph lies *above* its tangent lines, and the slopes of the tangent lines are increasing.', ''),
                (6, 'Differentiate y = sin(x) * cos(x) using two different methods (Product Rule vs. Identity).', 'Method 1 (Product): cos(x)cos(x) - sin(x)sin(x) = cos(2x). Method 2 (Identity): Rewrite as 0.5sin(2x). Deriv is 0.5 * cos(2x) * 2 = cos(2x).', ''),
                (7, 'Why does the Second Derivative Test work? (i.e., Why does f\'\'(c) < 0 imply a Maximum?)', 'If f\'\'(c) < 0, the function is Concave Down (frowning). A horizontal tangent (f\'=0) at the top of a frown must be a Peak (Maximum).', ''),
                (8, 'What is an Inflection Point? strictly in terms of the second derivative.', 'An inflection point is a point where the second derivative f\'\'(x) *changes sign* (from positive to negative or vice versa). It is not enough for f\'\' to just be zero.', ''),
                (9, 'If lim_{x->inf} f(x) = 5, what does this tell us about the graph of f\'(x) (the derivative) as x approaches infinity?', 'If the function flattens out to a horizontal asymptote y=5, the slope (derivative) must approach 0.', ''),
                (10, 'When applying L\'Hôpital\'s Rule, why must we check that the limit is an "Indeterminate Form" first?', 'Because if the limit is determinate (like 5/0 or 0/5), L\'Hôpital\'s Rule gives the wrong answer. It only works when there is a "struggle" between numerator and denominator (0/0 or inf/inf).', ''),
                (11, 'What does the "+ C" represent when finding the General Antiderivative? Why is it geometrically necessary?', 'It represents the "Constant of Integration." Geometrically, it means a family of vertically shifted curves. Since the derivative (slope) is the same regardless of vertical height, we must account for all possible vertical starting positions.', ''),
                (12, 'How does Optimization (finding global max/min) on a *closed* interval [a, b] differ from an *open* interval?', 'On a closed interval, you MUST check the endpoints (f(a) and f(b)) in addition to the critical points. The absolute max/min could occur at the very edge of the domain.', '')
            ]
        },
    ])
    ...
    quizzes.extend([
        ...
        },
        {
            ...
            'description': "Solve the problems below. For each question, type your final answer. After submitting, you will see the detailed step-by-step solution. Compare your work honestly and mark yourself correct only if your process and answer align.",
            'questions': [
                (1, 'Find the critical points of $f(x) = 2x^3 - 9x^2 + 12x$.', 'x = 1 and x = 2', '1. Find $f\'(x) = 6x^2 - 18x + 12$.\n2. Set to 0: $6(x^2 - 3x + 2) = 0$.\n3. Factor: $6(x-1)(x-2) = 0$.\n4. Critical points at $x=1, x=2$.'),
                (2, 'Determine the intervals where $f(x) = x^3 - 12x$ is Decreasing.', '(-2, 2)', '1. $f\'(x) = 3x^2 - 12$.\n2. Critical points: $3(x^2 - 4) = 0 \\to x = \\pm 2$.\n3. Test intervals: For $x=0$ (between -2 and 2), $f\'(0) = -12$ (Negative).\n4. Since $f\' < 0$, it is decreasing on $(-2, 2)$.'),
                (3, 'Find the slope of the tangent line to $x^2 + y^2 = 25$ at $(3, 4)$ using Implicit Differentiation.', '-3/4', '1. Differentiate: $2x + 2y y\' = 0$.\n2. Solve for $y\': y\' = -x/y$.\n3. Plug in $(3,4): -3/4$.'),
                (4, 'Apply the Mean Value Theorem to $f(x) = x^2$ on $[0, 4]$. Find the value $c$.', 'c = 2', '1. Average slope: $(f(4)-f(0))/(4-0) = (16-0)/4 = 4$.\n2. Instantaneous slope: $f\'(c) = 2c$.\n3. Set equal: $2c = 4 \\to c = 2$.'),
                (5, 'Use the Second Derivative Test to classify the critical point $x=0$ for $f(x) = 1 - x^2$.', 'Local Maximum', '1. $f\'(x) = -2x$. Critical point at $x=0$.\n2. $f\'\'(x) = -2$.\n3. Evaluate: $f\'\'(0) = -2$ (Negative).\n4. Negative concavity means a frown, so it is a Maximum.'),
                (6, 'Differentiate $y = x^x$ (Hint: Use Logarithmic Differentiation).', 'x^x (1 + ln(x))', '1. $\\ln y = x \\ln x$.\n2. $y\'/y = 1 \\cdot \\ln x + x(1/x) = \\ln x + 1$.\n3. $y\' = y(\\ln x + 1) = x^x(1 + \\ln x)$.'),
                (7, 'Evaluate using L\'Hôpital\'s Rule: $\\lim_{x \\to 0} \\frac{e^x - 1 - x}{x^2}$.', '1/2', '1. Check: $e^0 - 1 - 0 = 0$ and $0^2 = 0$. Form 0/0.\n2. L\'Hopital 1: $\\frac{e^x - 1}{2x}$. Check: $0/0$ again.\n3. L\'Hopital 2: $\\frac{e^x}{2}$.\n4. Evaluate: $e^0 / 2 = 1/2$.'),
                (8, 'Find the general antiderivative of: $3x^2 + \\sin x$.', 'x^3 - cos(x) + C', '1. Power rule reversed for $3x^2$: $\\frac{3x^3}{3} = x^3$.\n2. Trig rule reversed for $\\sin x$: The deriv of $-\\cos x$ is $\\sin x$, so antideriv is $-\\cos x$.\n3. Add + C.'),
                (9, 'Evaluate $\\lim_{x \\to \\infty} \\frac{\\ln x}{x}$ using L\'Hôpital\'s Rule concepts.', '0', 'Logarithms grow much slower than polynomials. Using L\'Hopital: Deriv top is $1/x$, Deriv bottom is 1. Limit $(1/x)/1$ as $x \\to \\infty$ is 0.'),
                (10, 'Find the point of inflection for $f(x) = x^3 - 6x^2$.', 'x = 2', '1. $f\'(x) = 3x^2 - 12x$.\n2. $f\'\'(x) = 6x - 12$.\n3. Set $f\'\' = 0 \\to 6x = 12 \\to x = 2$.\n4. Check sign change: $f\'\'(1) = -6$, $f\'\'(3) = +6$. Signs change, so it is an inflection point.'),
                (11, 'Find the absolute maximum of $f(x) = x^2 - 4x$ on the interval $[0, 5]$.', '5 (at x=5)', '1. Critical pt: $2x - 4 = 0 \\to x=2$.\n2. Check Endpoints and Critical pt:\n   f(0) = 0\n   f(2) = 4 - 8 = -4\n   f(5) = 25 - 20 = 5\n3. Max is 5.'),
                (12, 'Find $f(x)$ if $f\'(x) = 4x + 1$ and $f(0) = 3$.', '2x^2 + x + 3', '1. Integrate $4x + 1$ to get $2x^2 + x + C$.\n2. Use condition $f(0) = 3$: $2(0)^2 + 0 + C = 3 \\to C = 3$.\n3. Final: $2x^2 + x + 3$.')
            ]
        },
        {
            ...
            'description': "Write your answer in your own words, then compare it to the model answer. Remember, this exercise is built on trust and personal responsibility. Marking incorrect answers as right mimics progress but hinders true understanding. Embrace the learning process—honesty here is the foundation of your growth.",
            'questions': [
                (1, 'Can a function have an Absolute Maximum but NO Local Maximums? Explain.', 'Yes. Consider a straight line $y=x$ on the closed interval $[0, 1]$. The Absolute Max is at $x=1$ (an endpoint). Endpoints are not typically considered "local" extrema because the function doesn\'t exist on both sides.', ''),
                (2, 'What is the difference between a function being "strictly increasing" and "non-decreasing"?', 'Strictly increasing means $f(b) > f(a)$ always. Non-decreasing allows for flat spots (f(b) >= f(a)), meaning the slope can be zero for a while, but never negative.', ''),
                (3, 'Differentiate the inverse trig function $y = \\arctan(x)$.', '$1 / (1 + x^2)$', ''),
                (4, 'Why does L\'Hôpital\'s Rule fail for the limit $\\lim_{x \\to \\infty} \\frac{x + \\sin x}{x}$? Explain structurally.', 'Because the derivative of the top is $1 + \\cos x$. As $x \\to \\infty$, this oscillates and has no limit. L\'Hôpital requires the limit of the derivatives to exist. (You must solve this by dividing by x instead).', ''),
                (5, 'If $f\'(x)$ represents velocity, what physical concept corresponds to an Inflection Point on the position graph?', 'An inflection point on position is where Concavity changes. Concavity corresponds to Acceleration. So, it is the moment where acceleration changes from positive to negative (jerk), or maximum speed.', ''),
                (6, 'State the derivative of $a^x$ (where a is a constant, $a>0$).', '$a^x \\ln(a)$. (Common mistake is forgetting the ln(a)).', ''),
                (7, 'How is the Mean Value Theorem used to prove that a function with a zero derivative everywhere ($f\'(x)=0$) must be a Constant function?', 'If $f\'(x)=0$ always, then for any two points $a, b$, the MVT says $(f(b)-f(a))/(b-a) = 0$. This implies $f(b)-f(a) = 0$, or $f(b)=f(a)$ for all points. Thus, constant.', ''),
                (8, 'Explain why we cannot simplify the antiderivative of $x \\cdot \\cos(x)$ into the antiderivative of $x$ times the antiderivative of $\\cos(x)$.', 'There is no "Product Rule for Integration" that simple. The integral of a product is NOT the product of integrals. You would need "Integration by Parts" (the reverse of the product rule).', ''),
                (9, 'Explain the behavior of $e^{-x}$ as $x \\to \\infty$.', 'It approaches 0. Negative exponents mean "1 over e^x". As denominator gets huge, fraction goes to 0.', ''),
                (10, 'Visually, if f\'(x) is an Odd Function (symmetric origin), what symmetry does the graph of f(x) likely have?', 'If the slopes are symmetric odd (like $x^2$ slopes are linear), the function is often Even (symmetric Y-axis). (e.g., antideriv of $x$ is $x^2/2$).', ''),
                (11, 'If we use Linear Approximation to estimate $\\sqrt{4.1}$ using the tangent at $x=4$, will our estimate be an Overestimate or Underestimate? Why?', 'Overestimate. The graph of $\\sqrt{x}$ is Concave Down. Tangent lines to concave down curves sit *above* the actual curve.', ''),
                (12, 'In Optimization, if you find a single critical point in an open interval, how can you confirm it is the Absolute Max without checking endpoints?', 'If it is the *only* critical point and it is a Local Max (by 1st/2nd deriv test), and the function is continuous, it must be the Absolute Max because the graph can never turn around to go higher.', '')
            ]
        },
        {
        ...
        },
        {
            ...
            'description': "Solve the problems below. For each question, type your final answer. After submitting, you will see the detailed step-by-step solution. Compare your work honestly and mark yourself correct only if your process and answer align.",
            'questions': [
                (1, 'Find the open intervals where $f(x) = xe^{-x}$ is Increasing.', '(-infinity, 1)', '1. Product Rule: $f\'(x) = 1 \\cdot e^{-x} + x(-e^{-x})$.\n2. Factor: $e^{-x}(1 - x)$.\n3. Critical pt at $x=1$ (since $e^{-x}$ is never 0).\n4. Test $x=0$: $1(1) = +$. Test $x=2$: $e^{-2}(-1) = -$.\n5. Increasing where positive: $(-\\infty, 1)$.'),
                (2, 'Evaluate limit using L\'Hôpital: $\\lim_{x \\to \\infty} \\frac{\\ln(x)}{x^{0.5}}$.', '0', '1. Form $\\infty/\\infty$. Apply L\'H.\n2. Deriv top: $1/x$. Deriv bot: $0.5x^{-0.5}$.\n3. Simplify: $(1/x) / (0.5/\\sqrt{x}) = \\frac{\\sqrt{x}}{0.5x} = \\frac{2}{\\sqrt{x}}$.\n4. As $x \\to \\infty$, $2/\\sqrt{x} \\to 0$.'),
                (3, 'Find the derivative of $y = 5^{x^2}$.', '5^{x^2} * ln(5) * 2x', '1. Rule for $a^u$: $a^u \\ln(a) u\'$.\n2. $u=x^2, u\'=2x$.\n3. Combine: $5^{x^2} \\ln(5) 2x$.'),
                (4, 'Analyze Concavity: Determine where $f(x) = x^4 - 4x^3$ is Concave Down.', '(0, 2)', '1. $f\'(x) = 4x^3 - 12x^2$.\n2. $f\'\'(x) = 12x^2 - 24x$.\n3. Set $f\'\'=0$: $12x(x-2)=0$. Inflection pts at 0, 2.\n4. Test interval $(0, 2)$ with $x=1$: $12(1)(-1) = -12$. Negative means Concave Down.'),
                (5, 'Optimization Setup: You have 100m of fence to build a rectangular rectangular pen against a barn (no fence needed on that side). Write the Area function $A(x)$ in terms of the width x.', 'A(x) = 100x - 2x^2', '1. Let width = x. Let length = y.\n2. Constraint: $2x + y = 100 \\to y = 100 - 2x$.\n3. Area = $x \\cdot y = x(100 - 2x) = 100x - 2x^2$.'),
                (6, 'If $x^2 + y^2 = 1$, show that $y\'\' = -1/y^3$. (Harder)', 'See Steps.', '1. $y\' = -x/y$.\n2. Quotient Rule for $y\'\'$: $\\frac{y(-1) - (-x)y\'}{y^2}$.\n3. Sub $y\'$: $\\frac{-y + x(-x/y)}{y^2} = \\frac{-y^2 - x^2}{y^3}$.\n4. Since $x^2+y^2=1$, numerator is $-1$. Result: $-1/y^3$.'),
                (7, 'Find the critical points of the function $y = |x - 3|$ and classify them.', 'x=3, Absolute Minimum', '1. This is a V-shape shifted to 3.\n2. Derivative is undefined at x=3 (sharp corner), so it IS a critical point.\n3. Graph shows it is the bottom of the V, so it is a Minimum.'),
                (8, 'Evaluate $\\lim_{x \\to 0} (1 + 2x)^{1/x}$. (Hint: Use Logarithms or recognition of *e*).', 'e^2', '1. Let $y = (1+2x)^{1/x}$. $\\ln y = \\frac{1}{x} \\ln(1+2x)$.\n2. Limit is $\\frac{\\ln(1+2x)}{x}$ (0/0 form).\n3. L\'Hopital: $\\frac{2/(1+2x)}{1}$.\n4. Evaluate at 0: $2/1 = 2$.\n5. $\\ln y = 2 \\to y = e^2$.'),
                (9, 'Determine the horizontal asymptote of $y = \\frac{5x^3 - 2}{10 - x^3}$.', 'y = -5', '1. Highest powers are both $x^3$.\n2. Ratio of coefficients: $5 / (-1) = -5$.\n3. Asymptote is $y = -5$.'),
                (10, 'Find the general antiderivative of $f(x) = \\sec^2(x) + e^{2x}$.', 'tan(x) + 0.5e^{2x} + C', '1. Know pairs: Deriv of $\\tan x$ is $\\sec^2 x$. So integral is $\\tan x$.\n2. Reverse Chain Rule: Deriv of $e^{2x}$ is $2e^{2x}$. So integral is $\\frac{1}{2}e^{2x}$.\n3. Add C.'),
                (11, 'Use the MVT to prove that $f(x) = \\sin(x) + 2x$ has NO horizontal tangent lines.', 'Derivative is cos(x) + 2, which is never 0.', '1. $f\'(x) = \\cos(x) + 2$.\n2. Since $\\cos(x)$ is always between -1 and 1, $f\'(x)$ is always between 1 and 3.\n3. Since $f\'$ is never 0, there are no horizontal tangents.'),
                (12, 'Find the global minimum of $f(x) = x + \\frac{1}{x}$ for $x > 0$.', '2', '1. $f\'(x) = 1 - x^{-2} = 1 - 1/x^2$.\n2. Set to 0: $1 = 1/x^2 \\to x^2 = 1$. Since $x>0$, $x=1$.\n3. Check Concavity: $f\'\'(x) = 2/x^3$. At $x=1$, $f\'\' > 0$ (Concave Up). So it is a Min.\n4. Value: $1 + 1/1 = 2$.')
            ]
        },
        {
            ...
            'description': "Solve the problems below. For each question, type your final answer. After submitting, you will see the detailed step-by-step solution. Compare your work honestly and mark yourself correct only if your process and answer align.",
            'questions': [
                (1, 'Differentiate: $y = (5x^3 + 2)^4$', '60x^2(5x^3 + 2)^3', 'Chain Rule + Power Rule.\n1. Outer: $4(\\dots)^3$. Inner: $5x^3+2$.\n2. Deriv of Inner: $15x^2$.\n3. Multiply: $4(5x^3+2)^3 \\cdot 15x^2 = 60x^2(5x^3+2)^3$.'),
                (2, 'Differentiate the "Sigmoid-style" function: $y = \\frac{1}{1 + e^{-x}}$.', 'e^{-x} / (1 + e^{-x})^2', 'Rewrite as $(1 + e^{-x})^{-1}$ and use Chain Rule.\n1. Outer (Power): $-1(1+e^{-x})^{-2}$.\n2. Inner ($1+e^{-x}$): Deriv is $-e^{-x}$.\n3. Multiply: $-1 \\cdot (-e^{-x}) \\cdot (1+e^{-x})^{-2}$.'),
                (3, 'Differentiate: $y = \\sin(\\cos(x))$', '-cos(cos(x)) * sin(x)', 'Chain Rule.\n1. Outer (sin): $\\cos(\\dots)$. Keep inner same: $\\cos(\\cos(x))$.\n2. Inner (cos): $-\\sin(x)$.\n3. Multiply: $\\cos(\\cos(x)) \\cdot [-\\sin(x)]$.'),
                (4, 'Differentiate: $y = e^{3x^2}$', '6x * e^{3x^2}', 'Chain Rule with Exponential.\n1. Outer ($e^u$): stays $e^{3x^2}$.\n2. Inner ($3x^2$): deriv is $6x$.\n3. Multiply: $6x e^{3x^2}$.'),
                (5, 'Differentiate: $y = \\ln(x^2 + 1)$', '2x / (x^2 + 1)', 'Chain Rule with Logarithm ($d/dx \\ln(u) = u\'/u$).\n1. $u = x^2+1$. $u\' = 2x$.\n2. Result: $\\frac{2x}{x^2+1}$.'),
                (6, 'Double Chain Rule: Differentiate $y = \\cos^4(2x)$', '-8cos^3(2x)sin(2x)', 'Rewrite as $[\cos(2x)]^4$. Three layers.\n1. Power: $4[\cos(2x)]^3$.\n2. Trig: deriv of $\\cos(2x)$ is $-\\sin(2x)$.\n3. Inside arg: deriv of $2x$ is $2$.\n4. Multiply all: $4 \\cdot [-\\sin(2x)] \\cdot 2 \\cdot \\cos^3(2x)$.'),
                (7, 'Product and Chain Mixed: Differentiate $y = x \\cdot e^{-x}$', 'e^{-x}(1 - x)', 'Product Rule first, then Chain.\n1. $u=x, v=e^{-x}$.\n2. $u\'=1$. $v\'=-e^{-x}$ (Chain Rule).\n3. $u\'v + uv\' = 1(e^{-x}) + x(-e^{-x})$.\n4. Factor out $e^{-x}$.'),
                (8, 'Find the tangent line slope for $y = (2x-1)^3$ at $x=1$.', '6', '1. Differentiate: $3(2x-1)^2 \\cdot 2 = 6(2x-1)^2$.\n2. Evaluate at $x=1$: $6(2(1)-1)^2 = 6(1)^2 = 6$.'),
                (9, 'Differentiate the square root: $y = \\sqrt{x^2 + 5}$', 'x / sqrt(x^2 + 5)', 'Rewrite as $(x^2+5)^{1/2}$.\n1. Power rule: $\\frac{1}{2}(x^2+5)^{-1/2}$.\n2. Inner deriv: $2x$.\n3. Multiply: $\\frac{1}{2} \\cdot 2x \\cdot \\frac{1}{\\sqrt{x^2+5}} = \\frac{x}{\\sqrt{x^2+5}}$.'),
                (10, 'Differentiate: $y = \\tan(5x)$', '5sec^2(5x)', 'Know your trig rules.\n1. Deriv of $\\tan(u)$ is $\\sec^2(u)$.\n2. Inner deriv of $5x$ is 5.\n3. Result: $5\\sec^2(5x)$.'),
                (11, 'Limits: Evaluate $\\lim_{x \\to 0} \\frac{\\sin(2x)}{3x}$', '2/3', 'Adjust the fraction to match $\\sin(u)/u$.\n1. Rewrite as $\\frac{\\sin(2x)}{2x} \\cdot \\frac{2x}{3x}$.\n2. Limit of $\\sin(2x)/2x$ is 1.\n3. Limit of $2x/3x$ is $2/3$.'),
                (12, 'Evaluate $\\lim_{x \\to \\infty} \\frac{e^x}{x^2}$', 'Infinity', 'Hierarchy of Growth.\n1. Exponentials ($e^x$) grow much faster than polynomials ($x^2$).\n2. The numerator overwhelms the denominator.\n3. The limit is positive infinity.')
            ]
        },
    ])

    # Quizzes 19-24 (Integrals Part 1)
    quizzes.extend([
        {
            ...
            'eval_method': Quiz.EvaluationMethod.AUTOMATED,
            'domain': Quiz.Domain.CALCULUS,
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Integrals',
            'description': "Test your memory of the basic anti-derivative formulas. These are the building blocks for all integration.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Integrals',
            'description': "Focused review of the Fundamental Theorem of Calculus equations and immediate consequences.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Integrals',
            'description': "Deep dive into the 'why' of integration. Focus on the area interpretation and the connection between rate limits and sums.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Integrals',
            'description': "Applying integration to real-world rates of change.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Integrals',
            'description': "Practice finding indefinite integrals. Do the work on paper, then check.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Integrals',
            'description': "Practice evaluating definite integrals using FTC Part 2.",
            'questions': [
    ...
    # Quizzes 25-30 (Integrals Part 2)
    quizzes.extend([
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Techniques',
            'description': "Tests the core rules behind substitution and integration by parts.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Techniques',
            'description': "Test your ability to set up complex integrals for solving.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Techniques',
            'description': "Develop the instinct for choosing the right method.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Techniques',
            'description': "Understanding infinity in integration.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Techniques',
            'description': "Practice standard integration techniques.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Techniques',
            'description': "Advanced problems involving trig substitution and improper integrals.",
            'questions': [
    ...
    # Quizzes 31-36 (Sequences & Series)
    quizzes.extend([
        {
            ...
            'description': "Foundational definitions for sequences and simple series behavior.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Sequences & Series',
            'description': "Test your memory of the conditions for various convergence tests.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Sequences & Series',
            'description': "Understand the subtle difference between sequences and series convergence.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Sequences & Series',
            'description': "Deep dive into power series representation of functions.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Sequences & Series',
            'description': "Practice finding limits of sequences and sums of geometric series.",
            'questions': [
        ...
        },
        {
            ...
            'subject': Quiz.Subject.CALCULUS_2,
            'topic': 'Sequences & Series',
            'description': "Determine if the following series converge or diverge.",
            'questions': [
